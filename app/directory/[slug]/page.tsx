        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-6 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900">
              ...
              Verify this orthopedic surgeon&apos;s current license directly with the relevant state medical
            ...
            />
            <p className="mt-4 text-sm text-gray-500">Run a different orthopedic surgeon{listing.city ? ` in ${listing.city}` : ""}? <Link href="/list-your-business" className="underline" style={{ color: verticalConfig.primaryColor }}>Add your business &rarr;</Link></p></>
          </div>
