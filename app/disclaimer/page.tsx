...
export const metadata: Metadata = {
  ...
  description:
    "Disclaimer and terms of use for DoINeedAOrthopedicSurgeon.com — a public orthopedic surgeon directory. Not a medical referral service and not medical advice.",
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-gray">
      ...
      <p className="text-gray-700 leading-relaxed">
        DoINeedAOrthopedicSurgeon.com is a public directory of licensed orthopedic surgeons compiled from publicly
      ...
      <p className="text-gray-700 leading-relaxed">
        ...
        advice, diagnosis, or treatment. Always seek the advice of a qualified orthopedic surgeon or other
      ...
      <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-2">
        Orthopedic Surgeon Listing Claims &amp; Corrections
      </h2>
      <p className="text-gray-700 leading-relaxed">
        Orthopedic Surgeons and their authorized representatives may claim, correct, update, or request
      ...
      <p className="text-gray-700 leading-relaxed">
        ...
        any orthopedic surgeon listed, nor between you and DoINeedAOrthopedicSurgeon.com.
      </p>

      <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-2">Limitation of Liability</h2>
      <p className="text-gray-700 leading-relaxed">
        DoINeedAOrthopedicSurgeon.com and its operators are not liable for any decisions made based on
