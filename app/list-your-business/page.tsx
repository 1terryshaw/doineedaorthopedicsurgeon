...
export const metadata: Metadata = {
  ...
  description: `Add your orthopedic surgeon to ${verticalConfig.name} for free. Free Verified listing, takes about 2 minutes.`,
};
    ...
    <section className="bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 py-12"><div className="max-w-xl mx-auto">
        <header className="text-center mb-8">
          <h1 className="text-3xl sm:text-4xl font-bold mb-3 leading-tight" style={{ color: verticalConfig.primaryColor }}>Add your orthopedic surgeon to {verticalConfig.name}</h1>
