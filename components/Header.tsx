    ...
    <header className="border-b bg-white relative z-50">
      <div className="max-w-7xl min-[1356px]:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link href="/" className={`${HEADER_FOCUS_RING} text-sm sm:text-xl font-bold min-[1356px]:shrink-0 min-[1356px]:mr-4`} style={{ color: verticalConfig.primaryColor }}>
            {verticalConfig.name}
          </Link>
          ...
          <div className="min-[1356px]:hidden flex items-center gap-2">
