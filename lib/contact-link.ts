...
// doineedaorthopedicsurgeon.com, probed 2026-09-26: /contact -> 404; footer shows NO contact email; supportEmail domain has no MX (undeliverable), so the canary's own deliverable mailbox terry@doineedapro.com is used (flagged for ruling).
